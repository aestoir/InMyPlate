...
namespace InMyPlate.Controllers
{
    public class RestaurantController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image,Likes,Save,CityId")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image,Likes,Save,CityId")] Restaurant restaurant)
        {
            if (id != restaurant.Id)
            {
                return NotFound();
